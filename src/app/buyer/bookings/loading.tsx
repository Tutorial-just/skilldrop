        ...
        <div className="relative p-6 md:p-8 lg:p-10">
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            {Array.from({ length: 5 }).map((_, index) => (
              <div
                key={index}
                className="card-soft rounded-[26px] p-4"
              >
                ...
                <div className="mt-2 h-4 w-32 animate-pulse rounded-full bg-white/70" />
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="card rounded-[26px] p-5 md:p-6">
            ...
            <div className="mt-6 grid gap-4">
              {Array.from({ length: 5 }).map((_, index) => (
                <div
                  key={index}
                  className="rounded-[26px] border border-[var(--border)] bg-white/64 p-4"
                >
