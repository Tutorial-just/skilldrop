        ...
        <div className="relative p-6 md:p-8 lg:p-10">
          ...
          <div className="mt-6 grid gap-8 xl:grid-cols-[1fr_auto] xl:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-lg leading-8 text-muted">
                Keep useful experts in one place so you can come back and book
                them later.
              </p>
            </div>
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-3">
            <MetricCard
              ...
              hint="Experts saved by you"
            />

            <MetricCard
              label="Available now"
              value={String(
                savedExperts.filter((item) => item.expert.availability.length > 0)
                  .length,
              )}
            ...
            <MetricCard
              label="Verified"
              value={String(
                savedExperts.filter((item) => item.expert.isVerified).length,
              )}
    ...
    <Card className="p-5 transition hover:-translate-y-0.5 hover:shadow-[var(--shadow-md)]">
      <div className="grid gap-5 lg:grid-cols-[1fr_230px] lg:items-start">
        ...
        <div className="grid gap-3 rounded-[24px] border border-[var(--border)] bg-white/64 p-4">
          ...
          <SideRow
            label="Saved"
            value={formatShortDate(saved.createdAt)}
          />
